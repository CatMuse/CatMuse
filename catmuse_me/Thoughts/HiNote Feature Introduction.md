---
{"publish":true,"title":"HiNote Feature Introduction","comments":true,"created":"2025-02-10","modified":"2025-07-22T18:31:35.310+08:00","tags":["Seed"],"cssclasses":""}
---
...
当打开包含高亮文本的笔记时，侧边栏会自动获取高亮文本以卡片的样式展示。支持以下三种格式的高亮标记：`双等号` 、`<mark> `、`<span>`。
