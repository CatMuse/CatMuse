...
我们相信每个人都应该拥有清晰思考和有效组织想法的工具。这就是为什么我们的工具可以免费供个人使用。
...
我们相信您的数据应该是未来可靠且易于访问的，无论您身在何处。这就是为什么我们使用简单、开放的文件格式，以防止锁定，并确保您的数据可以保存到未来的世代。
...
我们相信您的想法和创意属于您自己，并且应该得到完全的隐私保护。这就是为什么您的数据存储在您的设备上，我们无法访问。当您使用我们的在线服务时，您的数据会通过端到端加密进行保护，以实现最大的安全性。
...
我们相信工具应该适应您的思维方式，而不是相反。这就是为什么我们设计我们的工具具有高度可定制性和可扩展性，这样您就可以根据自己独特的需求来塑造它们。

## Independent

We believe in staying true to these principles. That's why we are 100% supported by our users, not investors.

我们坚信遵守这些原则。这就是为什么我们 100%由我们的用户支持，而不是投资者。
