...
tags:
  ...
  - Evergreen
publish: true
description: In an age where we're obsessed with capturing everything, the real skill is knowing what to let go of. Forgetting is not loss—it's curation.
aliases:
comments: false
---
...
1. **Immediate use** - Things I need right now for a project or task. These get deleted when the work is done.
2. **Reference material** - Things I know I'll need to look up again (technical specs, documentation). These are indexed but not dwelt on.
3. **Seed ideas** - Fragments that feel like they could grow into something bigger. These get attention, iteration, and connection.
...
[[Knowledge]] | [[Evergreen]] | [[A Digital Garden for the AI Age]]
